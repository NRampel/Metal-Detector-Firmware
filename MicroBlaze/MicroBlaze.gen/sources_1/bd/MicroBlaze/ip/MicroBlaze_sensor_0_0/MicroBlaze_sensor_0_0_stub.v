...
// Command     : write_verilog -force -mode synth_stub -rename_top MicroBlaze_sensor_0_0 -prefix
//               MicroBlaze_sensor_0_0_ MicroBlaze_sensor_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "MicroBlaze_sensor_0_0,sensor,{}" *) (* core_generation_info = "MicroBlaze_sensor_0_0,sensor,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=sensor,x_ipVersion=1.0,x_ipCoreRevision=8,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4,depth=2}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "sensor,Vivado 2025.2" *) 
module MicroBlaze_sensor_0_0(echo_in, trig_out, s00_axi_aclk, 
